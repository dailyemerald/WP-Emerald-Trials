...
class ode
{
	...
	function action_init() {
		...
		add_action( 'wp_head', 'ode_head_adgear' ); // IV, 20120105, adds header code for new ad tags
		//add_action( 'wp_head', 'ode_head_fb_sdk'); // replaced in header.php
		...
		add_action( 'wp_footer', 'CP_trackingFooter' ); //include CMN new GoogleAnalytics tracking footer code. IV
	...
	function action_wp_head() {
		...
		//removed when switching to new ad tags on 20120105, IV
